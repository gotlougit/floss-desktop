...
`sources.json` records the official upstream Git URL and base commit for each component. Each
...
rebase. The Nix builds apply these patches to the pinned remote sources.
